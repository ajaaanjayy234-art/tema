...
# ============================================================
# SKRIP INI DI-REMAKE OLEH SAGA OFFICIAL (TELEGRAM: @saga011212)
...
display_welcome() {
  ...
  echo -e "${BOLD}${BLUE}[+]                  © SAGA OFFICIAL                [+]${NC}"
  echo -e "${BOLD}${BLUE}[+]                                                 [+]${NC}"
  echo -e "${BOLD}${BLUE}[+] =============================================== [+]${NC}"
  echo -e ""
...
check_token() {
  echo -e "                                                       "
  echo -e "${BOLD}${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BOLD}${BLUE}[+]              SAGA OFFICIAL LICENSE            [+]${NC}"
  echo -e "${BOLD}${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${BOLD}${YELLOW}MASUKKAN AKSES TOKEN: ${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "sagadev" ]; then
...
install_theme() {
  ...
  while true; do
    ...
    case "$SELECT_THEME" in
      1) THEME_NAME="Stellar"; THEME_URL="https://raw.githubusercontent.com/ajaaanjayy234-art/tema/main/stellar.zip"; break;;
      2) THEME_NAME="Billing"; THEME_URL="https://raw.githubusercontent.com/ajaaanjayy234-art/tema/main/billing.zip"; break;;
      3) THEME_NAME="Enigma"; THEME_URL="https://raw.githubusercontent.com/ajaaanjayy234-art/tema/main/enigma.zip"; break;;
      4) THEME_NAME="Elysium"; THEME_URL="https://raw.githubusercontent.com/ajaaanjayy234-art/tema/main/elysium.zip"; break;;
      5) THEME_NAME="Nightcore"; THEME_URL="https://raw.githubusercontent.com/ajaaanjayy234-art/tema/main/nightcore.zip"; break;;
      6) THEME_NAME="Ice"; THEME_URL="https://raw.githubusercontent.com/ajaaanjayy234-art/tema/main/ice.zip"; break;;
      7) THEME_NAME="Noobe"; THEME_URL="https://raw.githubusercontent.com/ajaaanjayy234-art/tema/main/noobe.zip"; break;;
      8) THEME_NAME="Nookure"; THEME_URL="https://raw.githubusercontent.com/ajaaanjayy234-art/tema/main/nookure.zip"; break;;
      9) THEME_NAME="Nebula"; THEME_URL="https://raw.githubusercontent.com/ajaaanjayy234-art/tema/main/nebula.zip"; break;;
      10) THEME_NAME="Recolor"; THEME_URL="https://raw.githubusercontent.com/ajaaanjayy234-art/tema/main/recolor.zip"; break;;
...
create_node() {
  ...
  bash <(curl -s https://raw.githubusercontent.com/ajaaanjayy234-art/node/refs/heads/main/createnode.sh)
...
while true; do
  ...
  echo -e "${BOLD}${CYAN}gggg      gg     ,    ggg${NC}      ${BOLD}${BLUE}By Saga Official${NC}"
  echo -e "${BOLD}${CYAN}ggg:     gg.     -   ,ggg${NC}       ${BOLD}${GREEN}----------------------------------${NC}"
  echo -e "${BOLD}${CYAN} ggg:     ggg._    _,ggg${NC}       ${BOLD}${BLUE}Telegram : @saga011212${NC}"
